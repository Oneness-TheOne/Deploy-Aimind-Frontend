...
const reviews = [
  {
    ...
    category: "청소년상담",
    content:
      "아이가 불안도가 높고, 자신감이 낮아서 상담을 시작했는데요. 회차를 거듭할수록 상담실 문을 나서는 아이의 표정이 밝아져서 부모로서 마음이 편안해요.",
  ...
  },
  {
    ...
    category: "아동상담",
    content:
      "아이가 마음이 불편할 때 배앓이가 심했는데, 지금은 증상이 싹 사라졌어요. 선생님께 배운 양육지식이 큰 도움이 되었어요.",
  ...
  },
  {
    ...
    category: "성인 개인상담",
    content:
      "상담 받기 전 2년 동안 우울, 불안으로 병원 다니면서 약을 먹었지만 좋아지지 않았어요. 상담 시작한지 3달도 되기 전에 변하기 시작해서 너무 신기해요.",
  ...
  },
  {
    ...
    category: "부모상담",
    content:
      "아이와 대화가 잘 안되고 갈등이 많았는데, 상담을 통해 아이의 마음을 이해하게 되었어요. 서로 마음을 열고 대화할 수 있게 되었습니다.",
  ...
  },
  {
    ...
    category: "그림심리분석",
    content:
      "아이가 그린 그림이 무엇을 의미하는지 몰랐는데, 분석 결과를 보고 아이의 숨은 감정을 알게 되었어요. 정말 놀라운 경험이었습니다.",
...
export function StatsSection() {
  ...
  // Extended reviews for seamless infinite loop
  ...
  // Reset to 0 seamlessly when reaching the cloned cards
  useEffect(() => {
      ...
      >
        ...
        <div className="flex justify-center mb-2">
          <svg className="w-10 h-10" viewBox="0 0 48 48" fill="none">
            <path
              d="M24 8C20 8 16 12 14 18C12 14 8 12 6 14C4 16 6 22 10 26C6 28 4 34 6 36C8 38 14 36 18 32C16 38 18 44 22 44C24 44 26 42 26 38"
              stroke="#14b8a6"
              strokeWidth="2"
              strokeLinecap="round"
              fill="none"
            />
            <path
              d="M24 8C28 8 32 12 34 18C36 14 40 12 42 14C44 16 42 22 38 26C42 28 44 34 42 36C40 38 34 36 30 32C32 38 30 44 26 44C24 44 22 42 22 38"
              stroke="#14b8a6"
              strokeWidth="2"
              strokeLinecap="round"
              fill="none"
      ...
      >
        ...
        <div className="flex justify-center px-4">
          <div
            ...
            style={{ width: 3 * CARD_WIDTH + 2 * CARD_GAP }}
          >
            <div
                    ...
                    <Card className="bg-white border-0 shadow-sm h-full">
                      <CardContent className="p-3 md:p-4">
                        ...
                        <div className="flex items-center gap-1 mb-1.5">
                          <Icon
                            className={`h-3 w-3 ${review.iconColor}`}
                            fill="currentColor"
                          />
